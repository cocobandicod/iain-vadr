...
import FormAdd from './form/form_add_dosen.vue';
import FormEdit from './form/form_edit_dosen.vue';
...
<template>
            ...
            <div class="col-xl-12">
              <div class="card card-height-100">
                <div class="card-header align-items-center d-flex">
                  <h4 class="card-title mb-0 flex-grow-1">Dosen</h4>
                </div>
                <!-- end card header -->
                <div class="card-body">
                  <div>
                  ...
                  <div v-else>
                    <table
                      ...
                      <tbody>
                        <tr v-for="(item, index) in dosen" :key="index">
                          <td>{{ index + 1 }}</td>
                          <td>
                            {{ item.nidn }}
                          </td>
                              ...
                              <ul
                                ...
                                <li>
                                  <button
                                    class="dropdown-item"
                                    @click.prevent="
                                      hapus_data(item.id, item.nama_dosen)
                                    ">
                                    <i
  ...
  <FormAdd @refresh="refreshDataTable" />
  <FormEdit :dataId="selectedId" @refresh="refreshDataTable" />
</template>
<style lang=""></style>
