...
//import FormAdd from './form/form_mahasiswa_add.vue';
//import FormEdit from './form/form_mahasiswa_edit.vue';
            ...
            <div class="col-xl-12">
              <div class="card card-height-100">
                <div class="card-header align-items-center d-flex">
                  <h4 class="card-title mb-0 flex-grow-1">Mahasiswa</h4>
                </div>
                <!-- end card header -->
                <div class="card-body">
                  <div>
                              ...
                              <ul
                                ...
                                <li>
                                  <button
                                    class="dropdown-item"
                                    data-bs-toggle="modal"
                                    data-bs-target="#FormMahasiswaEdit"
                                ...
                                <li>
                                  <button
                                    class="dropdown-item"
                                    @click.prevent="
                                      hapus_data(item.id, item.nama_mahasiswa)
                                    ">
                                    <i
