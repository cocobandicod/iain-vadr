        ...
        <div class="row justify-content-center">
          <div class="col-lg-10">
            <div class="card shadow-none">
              <div class="card-body">
                <div class="row justify-content-center">
                  <div class="col-lg-10 col-md-10 col-sm-12 col-xl-8">
                    ...
                    <form action="#">
                      <div class="row g-3">
                        ...
                        <p>*Identitas Nama anda akan dijaga kerahasiaanya</p>
                        <div class="d-flex align-items-start gap-3 mt-4 mb-5">
                          <router-link
                            class="btn btn-light previestab"
                            :to="{ name: 'DosenDashboardPengaduanLaporan' }">
                            <i class="ri-file-list-line me-1"></i>
                            Laporan Pengaduan
                          </router-link>
                          <button
                            type="submit"
                            class="btn btn-success right ms-auto nexttab nexttab"
